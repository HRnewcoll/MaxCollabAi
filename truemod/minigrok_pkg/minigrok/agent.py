...
import os, json, re, logging, threading, queue
import warnings
...
from .models import model, quick, stream_gen, MODEL_MAX_TOKENS
from .generation import (_build_msgs, detect_subject, _strip_think,
                          SUBJECT_PROMPTS, SYSTEM_PROMPT, ctx_info,
                          reflect_and_improve, _custom_system_prompt)
from .rag import rag_retrieve, rag_add, classify_domain
from .memory import (session_primer, save_conversation, compress_history,
                     mem_set, mem_get, export_conversation)
from .utils import pii_filter, injection_check, _response_cache
...
def agent_stream(message, history, image_path=None, log_fn=None):
    from .registry import TOOL_REGISTRY  # lazy — avoids circular import
    """
